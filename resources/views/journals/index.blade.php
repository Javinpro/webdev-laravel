...
<head>
    ...
    <title>Journals Data - Javin E. C.</title>
                            ...
                            <tbody>
                                @forelse ($journals as $journal)
                                    <tr>
                                        <td class="text-center">
                                            <img src="{{ asset('/storage/journals/'.$journal->image) }}" class="rounded" style="width: 150px">
                                        </td>
                                        <td>{{ $journal->title }}</td>
                                        <td>{{ "Rp " . number_format($journal->price,2,',','.') }}</td>
                                        <td>{{ $journal->stock }}</td>
                                        <td class="text-center">
                                ...
                                @empty
                                    <div class="alert alert-danger">
                                        journals data aren't available
                                    </div>
                                @endforelse
                            </tbody>
                        </table>
